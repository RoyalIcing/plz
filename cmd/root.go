...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.plz.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".plz" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".plz")
	}
